...
- **틀(상단바·레일·상태바, 도구·분류기 헤더·왼쪽 메뉴)은 세 밝기 모두 짙은 남회색 #232a33.**
  흰 면적이 줄고 노랑 [실행]·브랜드 마크가 또렷해진다. 틀까지 밝게 두면 전부 비슷한 회색이라 칙칙했다
- soft: 순백(#fff) 대신 푸른기 도는 오프화이트(패널 #f6f7f9, 작업판 #eef1f4). 처음엔 누런 회색
  (#f5f5f2)이었는데 칙칙하다는 의견으로 바꿨다. 글자 #1c2128 대비 약 15:1, 보조 글자 7:1 이상
- dark: #1d2025 계열. 순수 검정은 안 쓴다(흰 글자 번짐, 카드 경계가 안 보임)
- 노랑도 한 단계 눌렀다(#ffd43b → soft #f5cc2e). 넓은 면적에는 노랑을 쓰지 않는다
