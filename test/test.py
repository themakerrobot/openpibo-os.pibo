...
def audio():
  audio_obj.play(filename="/home/pi/openpibo-files/audio/effect/opening.mp3", volume=80)
  time.sleep(5)
  audio_obj.stop()
...
def camera():
  oled_obj.imshow(camera_obj.read())
...
if __name__ == "__main__":
  ...
  while True:
    ...
    console.print(table)
    console.print("© Copyright 2025, Circulus Education - THE MAKER\n")
